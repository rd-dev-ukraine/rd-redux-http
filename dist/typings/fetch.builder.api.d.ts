import { ReduxHttpCustomRequestFactory, ReduxHttpFetchResultConfig, ReduxHttpFetchRequestWithBodyFactory } from "./api";
...
export declare type FetchRequestConfiguration<TParams> = QueryStringConfigurator<TParams> & BodyConfigurator<TParams> & PreConfigurator<TParams> & ResultConfigurator<TParams>;
...
export interface PreConfiguratorWithBody<TParams, TBody> {
    pre(middleware: (request: RequestInit, params: TParams, body: TBody) => RequestInit): ResultConfiguratorWithBody<TParams, TBody> & PreConfiguratorWithBody<TParams, TBody> & FetchCoreWithBodyConfigurator<TParams, TBody>;
}
